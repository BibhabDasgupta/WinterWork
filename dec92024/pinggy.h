...
//================
typedef pinggy_void_t (*pinggy_authenticated_cb_t)(pinggy_ref_t);
typedef pinggy_void_t (*pinggy_authentication_failed_cb_t)(pinggy_ref_t, pinggy_len_t, pinggy_char_p_p_t);
typedef pinggy_void_t (*pinggy_reverse_forwrding_done_cb_t)(pinggy_ref_t, pinggy_len_t, pinggy_char_p_p_t);
typedef pinggy_void_t (*pinggy_reverse_forwrding_failed_cb_t)(pinggy_ref_t, pinggy_const_char_p_t);
typedef pinggy_void_t (*pinggy_disconnected_cb_t)(pinggy_ref_t, pinggy_const_char_p_t, pinggy_len_t, pinggy_char_p_p_t);
typedef pinggy_bool_t (*pinggy_new_channel_cb_t)(pinggy_ref_t, pinggy_ref_t);
 ...
 */
PINGGY_EXPORT pinggy_bool_t
pinggy_tunnel_set_authenticated_callback(pinggy_ref_t tunnel, pinggy_authenticated_cb_t authenticated);
 ...
 */
PINGGY_EXPORT pinggy_bool_t
pinggy_tunnel_set_authentication_failed_callback(pinggy_ref_t tunnel, pinggy_authentication_failed_cb_t authentication_failed);
 ...
 */
PINGGY_EXPORT pinggy_bool_t
pinggy_tunnel_set_reverse_forwrding_done_callback(pinggy_ref_t tunnel, pinggy_reverse_forwrding_done_cb_t reverse_forwrding_done);
 ...
 */
PINGGY_EXPORT pinggy_bool_t
pinggy_tunnel_set_reverse_forwrding_failed_callback(pinggy_ref_t tunnel, pinggy_reverse_forwrding_failed_cb_t reverse_forwrding_failed);
 ...
 */
PINGGY_EXPORT pinggy_bool_t
pinggy_tunnel_set_disconnected_callback(pinggy_ref_t tunnel, pinggy_disconnected_cb_t disconnected);
 ...
 */
PINGGY_EXPORT pinggy_bool_t
pinggy_tunnel_set_new_channel_callback(pinggy_ref_t tunnel, pinggy_new_channel_cb_t new_channel);

//========================================
//          Channel Functions
//========================================

typedef pinggy_void_t (*pinggy_channel_data_received_cb_t)(pinggy_ref_t);
typedef pinggy_void_t (*pinggy_channel_readyto_send_cb_t)(pinggy_ref_t, pinggy_uint32_t);
typedef pinggy_void_t (*pinggy_channel_error_cb_t)(pinggy_ref_t, pinggy_const_char_p_t, pinggy_len_t);
typedef pinggy_void_t (*pinggy_channel_cleanup_cb_t)(pinggy_ref_t);
 ...
 */
PINGGY_EXPORT pinggy_bool_t
pinggy_tunnel_channel_set_data_received_callback(pinggy_ref_t channel, pinggy_channel_data_received_cb_t data_received);
 ...
 */
PINGGY_EXPORT pinggy_bool_t
pinggy_tunnel_channel_set_ready_to_send_callback(pinggy_ref_t channel, pinggy_channel_readyto_send_cb_t readyto_send);
 ...
 */
PINGGY_EXPORT pinggy_bool_t
pinggy_tunnel_channel_set_error_callback(pinggy_ref_t channel, pinggy_channel_error_cb_t error);
 ...
 */
PINGGY_EXPORT pinggy_bool_t
pinggy_tunnel_channel_set_cleanup_callback(pinggy_ref_t channel, pinggy_channel_cleanup_cb_t cleanup);
